 ...
 *     return a chapter11_socket descriptor ready for reading and writing. This
...
int open_clientfd(char *hostname, char *port) {
    ...
    for (p = listp; p; p = p->ai_next) {
        /* Create a chapter11_socket descriptor */
...
/*  
 * open_listenfd - Open and return a listening chapter11_socket on port. This
 *     function is reentrant and protocol-independent.
 *
 *     On error, returns: 
 *       -2 for getaddrinfo error
...
int open_listenfd(char *port) 
{
    ...
    /* Make it a listening chapter11_socket ready to accept connection requests */
